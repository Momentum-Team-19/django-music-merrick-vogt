...
def spotify_login(request):
    ...
    print(f"Session ID before: {request.session.session_key}")
    print(f"User ID in Session before: {request.session.get('user_id')}")
    ...
    print(f"Session ID after: {request.session.session_key}")
    print(f"User ID in Session after: {request.session.get('user_id')}")
